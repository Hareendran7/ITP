 ...
 * @author gange
 */
public class damageUI extends javax.swing.JFrame {
    ...
    public damageUI() throws SQLException {
        initComponents();
        p1=new dsuppp();
        p2=new dret();
        p3=new dsearch();
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(867, 559));
        ...
        jPanel3.setPreferredSize(new java.awt.Dimension(867, 559));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(damageUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new damageUI().setVisible(true);
            } catch (SQLException ex) {
                Logger.getLogger(damageUI.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    }
